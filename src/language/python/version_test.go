...
func TestCompareVersions(t *testing.T) {
	...
	tests := []struct {
		...
		{"prerelease less than release", "1.0.0a1", "1.0.0", -1, false},
		...
		{"pep440 dev release", "1.0.0.dev1", "1.0.0", -1, false},
		{"pep440 post release", "1.0.0.post1", "1.0.0", 1, false},
	}

	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got, err := py.CompareVersions(tt.a, tt.b)
