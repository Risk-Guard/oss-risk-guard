...
import (
	...
	"github.com/Risk-Guard/oss-risk-guard/src/parsers/python/pyproject"
	"github.com/Risk-Guard/oss-risk-guard/src/parsers/python/setup"
	"github.com/Risk-Guard/oss-risk-guard/src/parsers/python/setupcfg"
)
...
func ParseManifest(detected models.DetectedManifest, repoRoot string) (*models.ManifestResult, error) {
	...
	if detected.Lockfile != nil {
		...
		result.LockfileDependencies = lockfile.AttachManifestLocations(edges, result.Dependencies)
	}
